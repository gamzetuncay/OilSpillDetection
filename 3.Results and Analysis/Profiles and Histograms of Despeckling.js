...
var region010316 = ee.Geometry.Rectangle(
    ...
    var VV_Pixels1 = sar1.first().reduceRegion(ee.Reducer.toList(), profile1);
    ...
    print(VV_ProfileChart1);// Display the profile.
...
var region080819 = ee.Geometry.Rectangle(
    ...
    print(VV_ProfileChart2_1);// Display the profile.
    ...
    print(VV_ProfileChart2_2);// Display the profile.
...
var region210719 = ee.Geometry.Rectangle(
    ...
    print(VV_ProfileChart3);// Display the profile.
...
var region220519 = ee.Geometry.Rectangle(
    ...
    print(VV_ProfileChart4);// Display the profile.
...
var region250915 = ee.Geometry.Rectangle(
    ...
    print(VV_ProfileChart5);// Display the profile.
